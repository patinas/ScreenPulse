...
# Gemini API settings
GEMINI_MODEL = "gemini-2.0-flash-lite"  # Fastest model: 30 RPM, 200 RPD free tier
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")

# Rate limiting (Free tier limits for gemini-2.0-flash-lite)
MAX_REQUESTS_PER_MINUTE = 28  # Stay under 30 RPM limit
MAX_REQUESTS_PER_DAY = 190  # Stay under 200 RPD limit
MIN_REQUEST_INTERVAL = 2.2  # Seconds between requests (60/28 ≈ 2.14s)
